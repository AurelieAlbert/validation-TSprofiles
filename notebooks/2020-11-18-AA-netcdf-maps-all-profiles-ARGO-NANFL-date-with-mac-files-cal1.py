...
def main():
	...
	ncfile='/mnt/meom/workdir/alberta/ARGO/ARGO_profiles_selection_for_NANFL_'+datemin[6:]+'-'+datemin[3:5]+'-'+datemin[0:2]+'-'+datemax[6:]+'-'+datemax[3:5]+'-'+datemax[0:2]+'.nc'
	ds_profiles=sc.selection_from_netcdf(ncfile,**params)
