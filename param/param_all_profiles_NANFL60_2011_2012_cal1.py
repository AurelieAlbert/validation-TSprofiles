...
case='BLBT02'
member=''
dirmod='/mnt/meom/workdir/alberta/eNATL60/eNATL60-I/'
coordfile='/mnt/meom/workdir/alberta/eNATL60/eNATL60-I/coordinates_eNATL60NANFL.nc'
maskfile='/mnt/meom/workdir/alberta/eNATL60/eNATL60-I/mask_eNATL60NANFL_3.6.nc'
hgrfile='/mnt/meom/workdir/alberta/eNATL60/eNATL60-I/mesh_hgr_eNATL60NANFL_3.6.nc'
zgrfile='/mnt/meom/workdir/alberta/eNATL60/eNATL60-I/mesh_zgr_eNATL60NANFL_3.6.nc'
batfile='/mnt/meom/workdir/alberta/eNATL60/eNATL60-I/eNATL60NANFL_BATHY_GEBCO_2014_2D_msk_v3.1_lb.nc4'
namlatmod='nav_lat'
namlonmod='nav_lon'
namdepmod='gdept_1d'
nammaskmod='tmask'
